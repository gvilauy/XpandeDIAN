...
package oasis.names.specification.ubl.schema.xsd.attacheddocument_2;
...
public class AttachedDocumentType {
    ...
    @XmlElement(name = "ParentDocumentTypeCode", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected ParentDocumentTypeCodeType parentDocumentTypeCode;
    @XmlElement(name = "ParentDocumentVersionID", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    ...
    @XmlElement(name = "Attachment", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
     ...
     * @return
     *     possible object is
     *     {@link ParentDocumentVersionIDType }
     *     
     */
    public ParentDocumentVersionIDType getParentDocumentVersionID() {
     ...
     *     
     */
    public void setParentDocumentVersionID(ParentDocumentVersionIDType value) {
        this.parentDocumentVersionID = value;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the parentDocumentLineReference property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<LineReferenceType> getParentDocumentLineReference() {
        if (parentDocumentLineReference == null) {
            parentDocumentLineReference = new ArrayList<LineReferenceType>();
        }
